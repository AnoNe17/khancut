...
class SoalSDQ4_11 extends StatefulWidget {
  ...
  const SoalSDQ4_11({Key? key, required this.login, required this.nama, required this.umur, required this.instansi}) : super(key: key);
...
class _SoalSDQ4_11State extends State<SoalSDQ4_11> {
  List<Soal> soal = [
    ...
    Soal('h', '2. Gelisah, terlalu aktif, tidak dapat diam untuk waktu lama.', 0, 1 ,2),
    Soal('e', '3. Sering mengeluh sakit kepala, sakit perut atau sakit lainnya.', 0, 1 ,2),
    Soal('pro', '4. Kalau mempunyai mainan, kesenangan atau pensil, anak bersedia berbagi dengan anak anak lain. ', 0, 1 ,2),
    Soal('c', '5. Sering sulit mengendalikan kemarahan. ', 0, 1 ,2),
    Soal('p', '6. Cenderung menyendiri lebih suka bermain seorang diri. ', 0, 1 ,2),
    Soal('c', '7. Umumya bertingkah laku baik, biasanya melakukan apa yang disuruh oleh orang dewasa.', 2, 1 ,0),
    Soal('e', '8. Banyak kekhawatiran atau sering tampak khawatir.', 0, 1 ,2),
    Soal('pro', '9. Suka menolong jika seseorang terluka, kecewa atau merasa sakit. ', 0, 1 ,2),
    Soal('h', '10. Terus menerus bergerak dengan resah atau menggeliat-geliat', 0, 1 ,2),
    Soal('p', '11. Mempunyai satu atau lebih teman baik', 2, 1 ,0),
    Soal('c', '12. Sering berkelahi dengan anak-anak lain atau mengintimidasi mereka', 0, 1 ,2),
    Soal('e', '13. Sering merasatidak bahagia, sedih atau menangis ', 0, 1 ,2),
    Soal('p', '14. pada umumnya di sukai oleh anak anak lain. ', 2, 1 ,0),
    Soal('h', '15. Mudah teralih perhatiannya, tidak dapat berkonsentrasi.  ', 0, 1 ,2),
    Soal('e', '16. Gugup atau sulit berpisah dengan orang tua/pengasuhnya pada situasi baru, mudah kehilangan rasa percaya diri. ', 0, 1 ,2),
    Soal('pro', '17. Bersikap baik terhadap anak-anak yang lebih muda.', 0, 1 ,2),
    Soal('c', '18. Sering berbohong atau berbuat curang', 0, 1 ,2),
    Soal('p', '19. Diganggu dipermainkan, dintimidasi atau diancam oleh anak-anak lain.', 0, 1 ,2),
    Soal('pro', '20. Sering menawarkan diri untuk membantu orang lain (orang tua, guru, anak-anak )', 0, 1 ,2),
    Soal('h', '21. Sebelum melakukan sesuatu ia berfikir dahulu tentang akibatnya.', 2, 1 ,0),
    Soal('c', '22. Mencuri dari rumah, sekolah atau tempat lain', 0, 1 ,2),
    Soal('p', '23. Lebih mudah berteman dengan orang dewasa dari pada dengan anak anak lain.', 0, 1 ,2),
    Soal('e', '24. Banyak yang ditakuti, mudah menjadi takut', 0, 1 ,2),
    Soal('h', '25. Memiliki perhatian yang baik terhadap apapun, mampu menyelesaikan tugas atau pekerjaan rumah sampai selesai .', 2, 1 ,0),
  ];
