            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Isi Data Pasien</h5>
                ...
                <table id="datatable" class="">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>
                                @if ($value->type === 'web')
                                    <div class="text-success">{{ $value->type }}</div>
                                @else
                                    <div class="text-primary">{{ $value->type }}</div>
                                @endif
                            </th>
                            <th>
